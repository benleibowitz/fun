...
public class NaiveBayesCommentAlgorithm implements SpamAlgorithm {
	...
	public NaiveBayesCommentAlgorithm(BayesEmailScoringSystem scoringSystem) {
	...
	public boolean isSpam(Message message) {
		...
		double weightedProbability = processText(message.getBody(), scoringSystem.getBodyProbabilityMap());
