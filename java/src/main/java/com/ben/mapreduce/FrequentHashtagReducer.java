...
public class FrequentHashtagReducer extends Reducer<Text, IntWritable, NullWritable, MongoUpdateWritable> {

	/**
	 * Sum the counts of all the hashtags to get their total
	 * frequencies.
	 */
    @Override
