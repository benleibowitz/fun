...
public class FrequentHashtagJob extends MongoTool {
	...
	public FrequentHashtagJob() throws UnknownHostException {
		...
		MongoConfigUtil.setInputURI(getConf(),
				"mongodb://hadoop:had00p@localhost:27017/sentiment.twitter");
		MongoConfigUtil
				.setOutputURI(getConf(),
						"mongodb://hadoop:had00p@localhost:27017/sentiment.frequenthashtags");
