...
/**
 * Pushes sample messages to a Kafka topic.
 * Assumes there is a Kafka broker on local host 9092
 */
public class TweetProducer {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException { 
        ...
        while(i >= 0) {
            ...
            KeyedMessage<String, String> data = new KeyedMessage<String, String>("ben_topic", message);
            producer.send(data);
            if(i % 10000 == 0) {
